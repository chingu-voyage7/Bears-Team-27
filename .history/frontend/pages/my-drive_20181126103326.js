...
class MyDrive extends React.Component {
  ...
  render() {
    return (
      ...
      >
        {JSON.stringify(this.props.pageProps.resources)}
        {this.props.pageProps.resources &&
          this.props.pageProps.resources.length > 0 &&
          this.props.pageProps.resources.map(item => {
            return (
              <MyDriveItem
                key={item._id}
